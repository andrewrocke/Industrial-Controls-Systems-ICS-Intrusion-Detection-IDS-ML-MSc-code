...
y_train_ds = train_ds['IT_B_Label']
X_train_ds = train_ds.drop('IT_B_Label', axis=1)
X_test_ds = test_ds.drop('IT_B_Label', axis=1)
y_test_ds = test_ds['IT_B_Label']
random_forest.fit(X_train_ds, y_train_ds)
#model = learner.train(train_ds)
y_pred_ds = random_forest.predict(X_test_ds)
