...
from sklearn.metrics import accuracy_score, confusion_matrix, precision_score, recall_score, ConfusionMatrixDisplay, roc_curve,  f1_score, roc_auc_score, auc, classification_report
...
model = RandomForestClassifier(n_estimators=25, random_state=42, max_depth=300, verbose=3)
#model = RandomForestClassifier(n_estimators=459, random_state=42, max_depth=16, verbose=3)
